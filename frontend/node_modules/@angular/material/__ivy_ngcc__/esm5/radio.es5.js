...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(MatRadioGroup, [{
    ...
    }], function () { return [{ type: ɵngcc0.ChangeDetectorRef }]; }, { name: [{
            type: Input
        }], labelPosition: [{
            type: Input
        }], value: [{
